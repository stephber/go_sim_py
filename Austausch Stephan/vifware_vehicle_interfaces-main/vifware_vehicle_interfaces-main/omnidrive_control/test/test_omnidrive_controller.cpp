...
class TestableOmniDriveControl : public omnidrive_control::OmniDriveControl
{
public:
  using OmniDriveControl::OmniDriveControl;
...
class TestOmniDriveControl : public ::testing::Test
{
protected:
  ...
  void SetUp() override
  {
    controller_ = std::make_unique<TestableOmniDriveControl>();
  ...
  const std::string controller_name = "test_omnidrive_control";
  std::unique_ptr<TestableOmniDriveControl> controller_;
...
TEST_F(TestOmniDriveControl, configure_fails_without_parameters)
{
...
TEST_F(TestOmniDriveControl, configure_fails_with_only_left_or_only_right_side_defined)
{
  const auto ret = controller_->init(controller_name);
  ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestOmniDriveControl, configure_fails_with_mismatching_wheel_side_size)
{
  const auto ret = controller_->init(controller_name);
  ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestOmniDriveControl, configure_succeeds_when_wheels_are_specified)
{
  const auto ret = controller_->init(controller_name);
  ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestOmniDriveControl, activate_fails_without_resources_assigned)
{
  const auto ret = controller_->init(controller_name);
  ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestOmniDriveControl, activate_succeeds_with_pos_resources_assigned)
{
  const auto ret = controller_->init(controller_name);
  ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestOmniDriveControl, activate_succeeds_with_vel_resources_assigned)
{
  const auto ret = controller_->init(controller_name);
  ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestOmniDriveControl, activate_fails_with_wrong_resources_assigned_1)
{
  const auto ret = controller_->init(controller_name);
  ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestOmniDriveControl, activate_fails_with_wrong_resources_assigned_2)
{
  const auto ret = controller_->init(controller_name);
  ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestOmniDriveControl, cleanup)
{
  const auto ret = controller_->init(controller_name);
  ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestOmniDriveControl, correct_initialization_using_parameters)
{
  const auto ret = controller_->init(controller_name);
  ASSERT_EQ(ret, controller_interface::return_type::OK);
