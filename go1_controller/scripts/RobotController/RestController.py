...
class RestController:
    ...
    def step(self, state, command):
        ...
        # Если self.use_imu == True, робот пытается удерживать тело в горизонтальном положении с помощью PID контроллера
        if self.use_imu:
